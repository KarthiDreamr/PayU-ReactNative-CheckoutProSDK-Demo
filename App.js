...
export default App = () => {
  // replace with your key and salt as needed
  ...
  const [email, setEmail] = useState('karthidreamr@gmail.com');
  const [phone, setPhone] = useState('9999999999');

  // replace with your surl and furl as needed
  ...
  const [environment, setEnvironment] = useState(1 + ''); // 0 for Production , 1 for Testing
  ...
  // replace with your payment modes order as needed
